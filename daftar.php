...
<tr>
<td colspan="2"><font size='5' style='font-family:snap itc;'><center>Register</center></td>
</tr>
<tr>
...
<tr>
<td><font size='4' style='font-family:snap itc; padding:15px;'>Nama Lengkap : </td>
<td><input name="nama" type="text" id="nama" style='width:300px;'></td>
</tr>
<tr>
<td><font size='4' style='font-family:snap itc; padding:15px;'>Alamat : </td>
<td><input name="alamat" type="text" id="alamat" style='width:400px;'></td>
</tr>
<tr>
<td><font size='4' style='font-family:snap itc; padding:15px;'>No. Telpon : </td>
<td><input name="no_telp" type="text" id="no_telp"></td>
</tr>
<tr>
<td><font size='4' style='font-family:snap itc; padding:15px;'>Email : </td>
...
<tr>
<td><font size='4' style='font-family:snap itc; padding:15px;'>Confirm Password : </td>
...
<tr>
<td colspan="2"><center><input type="submit" name="Submit" value="Register"
