...
<html lang="en">
 ...
 <body>
	 ...
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
	   <ul class="dropdown-menu">
		...
		<li class="active"><a href="prog.php">Program Kegiatan</a></li>
  ...
  <div class="container">
   <div class="row">
    <div class="col-lg-12">
	 <h1 class="page-header">PROGRAM KEGIATAN</h1>
	 <ol class="breadcrumb">
	  <li><a href="index.php">Home</a></li>
   ...
   <div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/pendidikan.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/agama.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/sosial.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/ekonomi.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/kesehatan.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/aqiqah.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/wakaf.jpg" alt=""></a>
	</div>
   </div>
