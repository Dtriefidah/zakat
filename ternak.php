...
<html lang="en">
 ...
 <body>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
	   ...
	   <ul class="dropdown-menu">
	    <li class="dropdown active"><a href="zakat.php">Info Zakat</a></li>
  ...
  <div class="container">
   <div class="row">
    <div class="col-lg-12">
	 ...
	 <ol class="breadcrumb">
	  ...
	  <li class="active">Zakat Binatang Ternak</li>
	 </ol>
	</div>
   </div>
   <div class="row">
	 ...
	 <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	   <div class="item active">
	    <img style="width:1200px; height:500px;" src="image/1.jpg" alt="">
	   </div>
	   <div class="item">
	    <img style="width:1200px; height:500px;" src="image/1.jpg" alt="">
	   </div>
   ...
   <h3 class="page-header">Zakat Binatang Ternak</h3>
   <div class="row">
   <div class="col-lg-12">
	 <ol class="breadcrumb">
<p>XXX
