...
<html lang="en">
 ...
 <body>
   ...
   <div class="container">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
	   <ul class="dropdown-menu">
	    <li><a href="sejarah.php">Sejarah GYD</a></li>
		<li><a href="vimis.php">Visi dan Misi</a></li>
		<li><a href="prog.php">Program Kegiatan</a></li>
		<li class="active"><a href="legal.php">Landasan Legal</a></li>
	   </ul>
	  </li>
  ...
  <div class="container">
   <div class="row">
    <div class="col-lg-12">
	 <h1 class="page-header">LANDASAN LEGAL</h1>
	 <ol class="breadcrumb">
	  <li><a href="index.php">Home</a></li>
	  <li><a href="profil.php">Profil</a></li>
	  <li class="active">Landasan Legal</a></li>
	 </ol>
	</div>
   </div>
   <div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/notaris.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal1.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal2.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal3.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal4.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal5.jpg" alt=""></a>
	</div>
   </div><div class="row">
    <div class="col-lg-12 img-portfolio">
	 <img class="img-responsive img-hover" src="image/legal6.jpg" alt=""></a>
	</div>
   </div>
