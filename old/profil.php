...
<html lang="en">
 ...
 <body>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
	   ...
	   <ul class="dropdown-menu">
	    <li><a href="sejarah.php">Info Zakat</a></li>
		<li><a href="vimis.php">Berita</a></li>
		<li><a href="prog.php">Majalah</a></li>
	   </ul>
	  </li>
  ...
  <div class="container">
   ...
   <h1 class="page-header">Sejarah GYD</h1>
   <div class="row">
    <div class="col-md-3">
	 <a href="sejarah.php"><img class="img-responsive img-hover" src="image/5.jpg" alt=""></a>
	</div>
   </div>
   <h1 class="page-header">Visi dan Misi</h1>
   <div class="row">
    <div class="col-md-3 img-portfolio">
	 <a href="vimis.php"><img class="img-responsive img-hover" src="image/2.jpg" alt=""></a>
	</div>
   </div>
   <h1 class="page-header">Program Kegiatan</h1>
   <div class="row">
    <div class="col-md-3 img-portfolio">
	 <a href="prog.php"><img class="img-responsive img-hover" src="image/pendidikan.jpg" alt=""></a>
	</div>
   </div>
   <h1 class="page-header">Landasan Legal</h1>
   <div class="row">
    <div class="col-md-3 img-portfolio">
	 <a href="legal.php"><img class="img-responsive img-hover" src="image/notaris.jpg" alt=""></a>
	</div>	
   </div>
