...
<html lang="en">
 ...
 <body>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
	   ...
	   <ul class="dropdown-menu">
	    <li class="active"><a href="zakat.php">Info Zakat</a></li>
  ...
  <div class="container">
   ...
   <h1 class="page-header">Info Zakat</h1>
   <div class="row">
    <div class="col-md-3">
	 <a href="sejarah.php"><img class="img-responsive img-hover" src="image/2.jpg" alt=""></a>
	</div>
   </div>
   <h1 class="page-header">Berita</h1>
   <div class="row">
    <div class="col-md-3 img-portfolio">
	 <a href="vimis.php"><img class="img-responsive img-hover" src="image/KBlnSuci.jpg" alt=""></a>
	</div>
   </div>
   <h1 class="page-header">Majalah</h1>
   <div class="row">
    <div class="col-md-3 img-portfolio">
	 <a href="prog.php"><img class="img-responsive img-hover" src="image/Capture.jpg" alt=""></a>
	</div>
   </div>
