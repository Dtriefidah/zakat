	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	 <ul class="nav navbar-nav navbar-left">
	  ...
	  <li  class="dropdown active"><a href="zakat.php" class="dropdown-toggle" data-toggle="dropdown">Calculator<b class="caret"></b></a>
	   <ul class="dropdown-menu">
	    <li class="active"><a href="fitrah.php">Zakat Fitrah</a></li>
...
<h2>Zakat Fitrah</h2>
Zakatnya adalah sebesar <strong>2,5 % atau 2,5 liter beras</strong>, yang <strong>wajib dikeluaran pada hari raya Idul Fitri.</strong>.
<br /><br />
<table class="form_perhitungan">
<tr>
	<th colspan="2" class="tableheader"><strong>Zakat Fitrah</strong></th>
</tr>
<tr>
	<th class="label_cols">Harga Beras</th>
	<th class="value_cols">Rp <input type="text" id="harga_beras" class="input_angka" onkeyup="validasiAngka(this); zc_fitrah();" onblur="validasi_numstring(this);" /></th>
</tr>
<tr>
